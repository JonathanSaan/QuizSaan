const data = [
  ...
  {
    questionText: "Which country has the most access to internet?",
    answerOptions: [
  ...
  },
  {
    ...
    answerOptions: [
      {
        answerText: "Keep your anti-virus software up to date",
        isCorrect: false,
      },
      {
        answerText:
  ...
  {
    questionText:
      'Who was Philosopher the say the phrase "It is not what happens to you, but how you react to it that matters."?',
    answerOptions: [
  ...
  },
  {
    ...
    answerOptions: [
      {
        answerText: "There is no such thing as true knowledge",
        isCorrect: false,
      },
  ...
  },
  {
    ...
    answerOptions: [
      ...
      {
        answerText: "Perceptions are sources of absolute knowledge",
        isCorrect: false,
      },
  ...
  },
  {
    ...
    answerOptions: [
      {
        answerText:
          "Push a rock up a hill but it would always come back to the same place",
        isCorrect: true,
      },
      {
        answerText: "Everything and everyone he touches will turn to gold",
        isCorrect: false,
      },
      {
        answerText: "To be locked in the darkest place of tartar",
        isCorrect: false,
      },
      {
        answerText: "Having your liver eaten all day by a big eagle",
        isCorrect: false,
      },
    ],
  },
